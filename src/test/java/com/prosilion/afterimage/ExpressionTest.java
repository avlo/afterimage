...
public class ExpressionTest {
  ...
  private final BadgeDefinitionEvent badgeDefinitionEvent;

  public ExpressionTest() {
    this.badgeDefinitionEvent = new BadgeDefinitionEvent(
  ...
  void testVariableParser() throws EvaluationException, ParseException, java.text.ParseException {
    ...
    PublicKey authorPublicKey = Identity.generateRandomIdentity().getPublicKey();
