...
//    Optional<EventIF> savedReputationEvent_1 = reputationEventPlugin.getExistingReputationEvent(upvotedUser, pairs_1.getFirst().addressTag());
...
//    Optional<EventIF> savedReputationEvent_2 = reputationEventPlugin.getExistingReputationEvent(upvotedUser, pairs_2.getFirst().addressTag());
...
//    Optional<EventIF> savedReputationEvent_5 = reputationEventPlugin.getExistingReputationEvent(upvotedUser, group5.getFirst().addressTag());
...
//    Optional<EventIF> savedReputationEvent_8 = reputationEventPlugin.getExistingReputationEvent(upvotedUser, group8.getFirst().addressTag());
...
//    Optional<EventIF> savedReputationEvent_10 = reputationEventPlugin.getExistingReputationEvent(upvotedUser, group10.getFirst().addressTag());
...
//    Optional<EventIF> savedReputationEvent_12 = reputationEventPlugin.getExistingReputationEvent(upvotedUser, group12.getFirst().addressTag());
...
//            new IdentifierTag(getKindType(i))))
//        .toList();
//
...
//  }
//
//  private String getKindType(int i) {
//    if (i % 2 == 0)
//      return AfterimageBaseConfig.UNIT_UPVOTE;
//    return AfterimageBaseConfig.UNIT_DOWNVOTE;
//  }
//
//  @Test
