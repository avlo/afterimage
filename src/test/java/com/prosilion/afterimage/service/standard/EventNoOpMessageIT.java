...
class EventNoOpMessageIT {
  ...
  @Autowired
  EventNoOpMessageIT(@NonNull AfterimageRelayStandardClient afterImageRelayStandardClient) {
  ...
  void testEventNoOpMessage() throws IOException {
    ...
    OkMessage okMessage = this.afterImageRelayStandardClient.sendEvent(globalEventJson);
