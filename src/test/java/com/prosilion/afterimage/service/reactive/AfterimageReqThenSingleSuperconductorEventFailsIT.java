...
//import com.prosilion.subdivisions.client.reactive.NostrEventPublisherSubscriber;
...
//    List<BaseMessage> reputationRequestSubscriber = new NostrSingleRelayRequestService(afterimageRelay.getUrl()).send(
...
//    NostrEventPublisherSubscriber nostrEventPublisherSubscriber = new NostrEventPublisherSubscriber(superconductorRelay.getUrl());
//    RequestSubscriber<OkMessage> okMessageRequestSubscriber = new RequestSubscriber<>(Duration.ofMillis(3000));
//    nostrEventPublisherSubscriber.send(new EventMessage(badgeAwardUpvoteEvent_1), okMessageRequestSubscriber);
//    assertEquals(true, okMessageRequestSubscriber.getItems().getFirst()
//        .getFlag());
...
//    List<BaseMessage> returnedAimgMessages = reputationRequestSubscriber;
////
