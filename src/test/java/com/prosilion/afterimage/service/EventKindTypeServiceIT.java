...
//
//import com.prosilion.afterimage.util.BadgeAwardDownvoteEvent;
//import com.prosilion.afterimage.util.BadgeAwardUpvoteEvent;
//import com.prosilion.afterimage.util.TestKindType;
...
//  private final BadgeDefinitionAwardEvent upvoteBadgeDefinitionEvent;
//  private final BadgeDefinitionAwardEvent downvoteBadgeDefinitionEvent;
//
...
//    this.upvoteBadgeDefinitionEvent = badgeDefinitionUpvoteEvent;
//    this.downvoteBadgeDefinitionEvent = badgeDefinitionDownvoteEvent;
...
//
//    BadgeAwardUpvoteEvent badgeAwardUpvoteEvent = new BadgeAwardUpvoteEvent(voterIdentity, upvotedUser, upvoteBadgeDefinitionEvent);
////    GenericNosqlEntityKindTypeDto genericEventKindTypeDto = new GenericNosqlEntityKindTypeDto(badgeAwardUpvoteEvent, TestKindType.UNIT_UPVOTE);
////    GenericEventKindTypeIF genericEventKindTypeIF = genericEventKindTypeDto.convertBaseEventToGenericEventKindTypeIF();
//
//    eventKindTypeService.processIncomingEvent(badgeAwardUpvoteEvent);
//
...
//    GenericEventKindTypeIF genericEventKindIF = new GenericNosqlEntityKindTypeDto(downvoteEvent, TestKindType.UNIT_DOWNVOTE).convertBaseEventToGenericEventKindTypeIF();
