...
class EventKindTypeServiceIT {
  ...
  public EventKindTypeServiceIT(
      ...
      BadgeDefinitionAwardEvent upvoteBadgeDefinitionEvent,
      BadgeDefinitionAwardEvent downvoteBadgeDefinitionEvent,
  ...
  void testUpvoteEvent() throws NostrException {
    ...
    GenericNosqlEntityKindTypeDto genericEventKindTypeDto = new GenericNosqlEntityKindTypeDto(event1, TestKindType.UNIT_UPVOTE);
