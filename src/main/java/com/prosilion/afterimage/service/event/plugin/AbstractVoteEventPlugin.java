...
public abstract class AbstractVoteEventPlugin
    extends NonPublishingEventKindTypePlugin
    implements FollowSetsCreatorPlugin {
  ...
  public void processIncomingEvent(@NonNull EventIF voteEvent) {
    ...
    afterimageFollowSetsEventPlugin.processIncomingEvent(
        createFollowSetsEvent(
            aImgIdentity,
            getTypeSpecificTags(PubKeyTag.class, voteEvent).getPublicKey(),
            getTypeSpecificTags(IdentifierTag.class, voteEvent),
