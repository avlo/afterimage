...
import com.prosilion.afterimage.service.clientresponse.ClientResponse;
import com.prosilion.afterimage.service.message.MessageService;
import com.prosilion.afterimage.service.message.RelayInfoDocService;
import com.prosilion.afterimage.service.request.pubsub.BroadcastMessageEvent;
import com.prosilion.afterimage.service.request.pubsub.TerminatedSocket;
...
@Controller
@EnableWebSocket
public class AfterimageController<T extends BaseMessage> extends TextWebSocketHandler implements WebSocketConfigurer {
  ...
  public void broadcastMessageEvent(BroadcastMessageEvent<BaseMessage> message) {
    ...
    log.debug("AfterimageController broadcast to\nsession:\n\t{}\nmessage:\n\t{}", sessionId, response.getPayload());
  }
