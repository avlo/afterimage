...
### 3.  Run locally as executable jar
    ...
    $ cd <your_git_home_dir>/afterimage
    $ java -jar target/afterimage-nostr-reputation-relay-1.4.0.war -Dafterimage.relay.url=ws://localhost:5556

----

### 4.  Run using pre-existing local application-server-container instance

    $ cp <your_git_home_dir>/afterimage/target/afterimage-nostr-reputation-relay-1.4.0.war <your_container/instance/deployment_directory>
